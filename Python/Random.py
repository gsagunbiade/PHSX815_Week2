...
class Random:
    ...
    # for four possible outcomes, the function outputs a random integer (0,1,2 or 3) based on a categorical distribution
    def Categorical(self, p1=0.55,p2=0.55, p3= 0.64):
         if p1 < 0. or p1 > 1.:
            return 1
         if p2 < 0. or p2 > 1.:
            return 2 
         ...
         # identify which interval the random number belongs to and then provide the corresponding result
